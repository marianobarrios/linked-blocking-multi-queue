 ...
 * allow <tt>null</tt> elements. Methods {@link #remove remove}, and {@link #element element} are
 * based on {@link #poll poll}, and {@link #peek peek}, respectively, but throw exceptions instead
 * of indicating failure via <tt>false</tt> or <tt>null</tt> returns.
 *
 * <p>A <tt>Pollable</tt> implementation that extends this class must minimally define methods
...
public abstract class AbstractPollable<E> implements Pollable<E> {
   ...
   *
   * <p>This implementation returns the result of <tt>poll</tt> unless the queue is empty.
   *
   ...
   *
   * <p>This implementation returns the result of <tt>peek</tt> unless the queue is empty.
   *
   * @return the head of this queue
   * @throws NoSuchElementException if this queue is empty
   */
