 ...
 */
public class DefaultSubQueueSelection<K, E>
    implements LinkedBlockingMultiQueue.SubQueueSelection<K, E> {
  ...
  @Override
  public void setPriorityGroups(
      ArrayList<LinkedBlockingMultiQueue<K, E>.PriorityGroup> priorityGroups) {
