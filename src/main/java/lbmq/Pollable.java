...
public interface Pollable<E> {
     ...
     * to itself result in {@link IllegalArgumentException}. Further, the behavior of this operation
     ...
     * exception is thrown. Attempts to drain a queue to itself result in {@link
