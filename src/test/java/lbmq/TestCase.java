 ...
 * classes, as well as a simple framework for helping to make sure that assertions failing in
 * generated threads cause the associated test that generated them to itself fail (which JUnit does
